...
void rx_data_proc(void)
{
	...
	/*
		1.t微妙=1000000/(baud/10)  ->传1字节(10bit)需要多少微妙  如，t=1000000/(115200/10)=86.8us
		2.t微妙=((psc+1) * (cnt+1)) / (TIMCLK/1000000)  ->已知等待接收到一个字节(10bit)的时间求cnt,cnt大过这个时间，代表貌似没有数据可接受了   如，通常令系统时钟通过psc分频后为1us,易得cnt=t-1
